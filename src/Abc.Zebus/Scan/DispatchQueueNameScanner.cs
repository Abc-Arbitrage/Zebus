...
public static class DispatchQueueNameScanner
{
    ...
    private static readonly ConcurrentDictionary<Assembly, AssemblyCache> _assemblyCaches = new();
    private static readonly ConcurrentDictionary<Type, string> _queueNames = new();
    ...
    {
        private readonly Dictionary<string, string> _knownQueueNames = new();
        private readonly ConcurrentDictionary<string, string> _namespaceQueueNames = new();
