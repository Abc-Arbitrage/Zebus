...
{
    public static readonly MessageTypeId EndOfStream = new("Abc.Zebus.Transport.EndOfStream");
    public static readonly MessageTypeId EndOfStreamAck = new("Abc.Zebus.Transport.EndOfStreamAck");
    public static readonly MessageTypeId PersistenceStopping = new("Abc.Zebus.PersistentTransport.PersistenceStopping");
    public static readonly MessageTypeId PersistenceStoppingAck = new("Abc.Zebus.PersistentTransport.PersistenceStoppingAck");
    ...
    internal static MessageTypeId GetMessageTypeIdBypassCache(Type? messageType)
        => new(MessageTypeDescriptorCache.GetMessageTypeDescriptorBypassCache(messageType));
    ...
    internal struct ProtobufSurrogate
    {
        ...
        public static implicit operator MessageTypeId(ProtobufSurrogate value) => new(value.FullName);
        public static implicit operator ProtobufSurrogate(MessageTypeId value) => new(value);
    }
}
